	...
	if(fltgrid)
	{
		...
		for(var i=0; i<n; i++)// this loop adds filters
		{
			...
			if(f==undefined || f["col_"+i]==undefined || f["col_"+i]=="none") 
			{
				...
				var inp = createElm( "input",["id","flt"+i+"_"+id],["type",inptype],["class",inpclass], ["aria-label", "Filter "+i] );					
			...
			else if(f["col_"+i]=="select")
			{
				...
				var slc = createElm( "select",["id","flt"+i+"_"+id],["class",inpclass], ["aria-label", "Filter "+i] );
